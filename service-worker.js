...
const CACHE_VERSION = 'pixel-office-v4';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
...
self.addEventListener('fetch', event => {
  ...
  const pdfHosts = ['cdnjs.cloudflare.com', 'cdn.jsdelivr.net', 'unpkg.com'];
  const isPDFEngine = pdfHosts.includes(url.hostname) && (url.pathname.includes('html2canvas') || url.pathname.includes('jspdf'));
